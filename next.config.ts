    ...
    return [
      {
        ...
        headers: [
          // Content Security Policy
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://sdk.cashfree.com https://*.cashfree.com https://checkout.razorpay.com",
              ...
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self' https://*.cashfree.com https://api.razorpay.com",
